...
// $GLOBALS['firstLabel']="ss";
// $GLOBALS['secondLabel']="";
// $GLOBALS['firstValues']="ss";
// $GLOBALS['seconValues']="";
// $arrayName;
// function getLabel()
// {
// 	//$GLOBALS['arrayName'] = array($GLOBALS['firstLabel'] ,$GLOBALS['secondLabel']);
// 	echo $GLOBALS['firstLabel'];
// 	echo $GLOBALS['secondLabel'];
// 	$arrayName = array($GLOBALS['firstLabel'] ,$GLOBALS['secondLabel'],$GLOBALS['firstValues'],$GLOBALS['secondValues']);
// 	return $arrayName;
// 	// $GLOBALS['z'] = $GLOBALS['x'] + $GLOBALS['y'];
// }
// function setLabel($first,$second,$firstValues,$secondValues)
// {
// 	$GLOBALS['firstLabel']=$first;
// 	$GLOBALS['secondLabel']=$second;
// 	$GLOBALS['fisrtValues']=$firstValues;
// 	$GLOBALS['secondValues']=$secondValues;
//
// }
...
$GLOBALS['firstAttr'] = array();
$GLOBALS['secondAttr'] = array();
$GLOBALS['attr'] = array();
    ...
    */
{
	...
	$questionDb=$questionid;
	echo $questionDb;
	$query="SELECT test FROM qa_posts WHERE postid={$questionDb}";
	...
	$dataaa=json_Encode($dataa[0],true);
	// echo $dataaa;
	$x=explode(",",$dataaa);
	$y=explode("\"",$x[0]);
	echo $y[1];
	...
	// $new_json=json_decode($data,true);
	// print_r($new_json[0]);
	// reset($new_json);
	// $first_key = key($new_json);
	// print_r($new_json);
	// $vlueee=reset($new_json);
	// $first_key=key($new_json);
	// echo $first_key;
	// // echo $new_json[0]["target"];
	// print_r(array_keys($new_json));
	...
	array_push($GLOBALS['attr'],$y[1]);
	array_push($GLOBALS['attr'],$x[1]);
	foreach ($dataa as $key => $value) {
		// echo $value[$y[1]].",".$value[$x[1]]."<br>";

		array_push($GLOBALS['firstAttr'], $value[$y[1]]);
		array_push($GLOBALS['secondAttr'], $value[$x[1]]);
		// print_r($stack);
		// $firstValues = $value["target"];
		// $secondValues = $value["source"];
		// setLabel($y[1],$x[1],$firstValues,$secondValues);
	}
	print_r($GLOBALS['firstAttr']);
	print_r($GLOBALS['secondAttr']);
	print_r($GLOBALS['attr']);
	...
	echo $questionDb;
	// $query="INSERT INTO
	// 	test_img (fileName,postId)
	// 	VALUES ('{$questionDb}',10)";
...
// INSERT INTO `test_img`(`fileName`, `fileId`, `postId`) VALUES ([value-1],[value-2],[value-3])
// echo $questionDb;
// $query="INSERT INTO
// 	test_img (fileName,postId)
// 	VALUES ('{$questionDb}',7)";
